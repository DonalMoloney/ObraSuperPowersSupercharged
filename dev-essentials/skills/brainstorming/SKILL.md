...
**The terminal state is invoking writing-plans.** Do NOT invoke any implementation skill, write code, or scaffold a project. The ONLY skill you invoke after brainstorming is writing-plans.
...
- Write the spec clearly and concisely — short sentences, concrete nouns, no filler
...
`visual-companion.md` (next to this skill file).
