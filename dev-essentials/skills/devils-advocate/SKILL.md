...
## Not this skill if
- The claim is already mechanically proven by passing tests (use the **verification-before-completion** skill) — refutation adds little
...
Stop plausible-but-wrong claims (especially research and design conclusions, which test-based verification cannot
...
**Don't use when:**
- The claim is already covered by a passing test suite — run the tests and capture evidence per the **verification-before-completion** skill instead
...
Dispatch N independent refuters as parallel agents. Each refuter receives the claim text
...
Spawn N independent agents in parallel, each tasked to disprove the claim, ideally
...
Dispatch the refuters as parallel agents. Pass each refuter the claim text and its assigned lens only.
